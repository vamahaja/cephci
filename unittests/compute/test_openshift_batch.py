...
CLUSTER_INSTANCE_TYPES = ["cx1.2xlarge", "cx1.2xlarge1gi", "cx1.4xlarge", "cx1.xlarge"]
...
@patch("compute.openshift.get_k8s_clients")
def test_apply_ocpvirt_vm_profile_defaults_to_cx1_xlarge(mock_clients):
    mock_clients.return_value = (_mock_custom_api(), MagicMock())
    params = apply_ocpvirt_vm_profile(
        {"image-name": "datasource://rhel9"},
        OCP_CRED,
    ...
    assert params["instancetype"] == DEFAULT_OCPVIRT_PROFILE
